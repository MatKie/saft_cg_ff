...
ff.add_crossint('CT', 'Na+', eps_mix=212.4)
ff.add_crossint('CT', 'Cl-', eps_mix=212.4)

ff.add_crossint('CM', 'Na+', eps_mix=213.01)
ff.add_crossint('CM', 'Cl-', eps_mix=213.01)
...
ff.add_crossint('SO4v6', 'CM', k=0.4)
ff.add_crossint('SO4v6', 'CT', k=0.4)
...
ff.write_forcefield(outfile='ffnonbonded_variation1.itp')
