...
ff.add_crossint('Wift25', 'Na+', eps_mix=200.52)
ff.add_crossint('Wift25', 'Cl-', eps_mix=217.65)
...
ff.add_crossint('SO4v6', 'Wift25', eps_mix=222.734) 
ff.add_crossint('SO4v6', 'Na+', eps_mix=21.14)
ff.add_crossint('SO4v6', 'CM', k=0.3)
ff.add_crossint('SO4v6', 'CT', k=0.3)
#ff.add_crossint('Na+', 'CM', k=0.6)
#ff.add_crossint('Na+', 'CT', k=0.6)
#ff.add_crossint('Cl-', 'CM', k=0.6)
#ff.add_crossint('Cl-', 'CT', k=0.6)

ff.add_crossint('SO4v9', 'Wift25', eps_mix=241.03) 
ff.add_crossint('SO4v9', 'Na+',  eps_mix=21.14)
ff.add_crossint('SO4v9', 'CM', k=0.3)
ff.add_crossint('SO4v9', 'CT', k=0.3)



ff.write_forcefield(outfile='ffnonbonded_nacl_v2.itp')
